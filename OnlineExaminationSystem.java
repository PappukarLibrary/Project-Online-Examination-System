...
public class OnlineExaminationSystem {
    public static void main(String[] args) {
        ...
        questions.add(new Question("Who is the president of the India?", Arrays.asList("Barack Pratibha Patil", "Droupadi Murmu", "Joe Biden", "George Bush"), 1));
        questions.add(new Question("Where is Tajmahal?", Arrays.asList("Kolkata", "Delhi", "UP", "Panjab"), 3));
